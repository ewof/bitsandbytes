...
void gemmex(Context *context, bool transposeA, bool transposeB, int m, int n, int k, void *A, void *B, void *C, int lda, int ldb, int ldc)
{
 ...
 //
	...
	// 				C, CUDA_R_32I, ldc,
 //          CUDA_R_32I, HIPBLAS_GEMM_DEFAULT_TENSOR_OP);
                    ...
                    long long int strideA, long long int strideB, long long int strideC, int batchCount)
{
  ...
  //printf("%i\n", batchCount);
          ...
          CUDA_R_32I, HIPBLAS_GEMM_DEFAULT);
...
// #ifdef NO_CUBLASLT
// #else
// template<int ORDER> hipsparseOrder_t' get_order()
// {
// 	switch(ORDER)
// 	{
// 		case ROW:
...
template <typename T, int SRC, int TARGET, bool transpose, int DTYPE> void transform(cublasLtHandle_t ltHandle, T *A, T *out, int dim1, int dim2)
{
#ifdef NO_HIPBLASLT
#else
  hipsparseOrder_t' orderA = get_order<SRC>();
  hipsparseOrder_t' orderOut = get_order<TARGET>();
  ...
  if(DTYPE == 8)
  {
    checkHipblasStatus(hipblasLtMatrixLayoutCreate(&A_desc, CUDA_R_8I, dim1, dim2, ldA));
    checkHipblasStatus(hipblasLtMatrixLayoutCreate(&out_desc, CUDA_R_8I, dim1, dim2, ldOut));
  }
  else if(DTYPE == 32)
  {
    checkHipblasStatus(hipblasLtMatrixLayoutCreate(&A_desc, CUDA_R_32I, dim1, dim2, ldA));
    checkHipblasStatus(hipblasLtMatrixLayoutCreate(&out_desc, CUDA_R_32I, dim1, dim2, ldOut));
  }
  else
  {
  ...
  checkHipblasStatus(hipblasLtMatrixTransformDescCreate(&A2Out_desc, CUDA_R_32F));
...
template void transform<int8_t, ROW, COL, false, 8>(hipblasHandle_t ltHandle, int8_t *A, int8_t *out, int dim1, int dim2);
template void transform<int8_t, ROW, ROW, false, 8>(hipblasHandle_t ltHandle, int8_t *A, int8_t *out, int dim1, int dim2);
template void transform<int8_t, ROW, COL32, false, 8>(hipblasHandle_t ltHandle, int8_t *A, int8_t *out, int dim1, int dim2);
template void transform<int32_t, ROW, COL32, false, 32>(hipblasHandle_t ltHandle, int32_t *A, int32_t *out, int dim1, int dim2);
template void transform<int8_t, ROW, COL_TURING, false, 8>(hipblasHandle_t ltHandle, int8_t *A, int8_t *out, int dim1, int dim2);
template void transform<int8_t, ROW, COL_AMPERE, false, 8>(hipblasHandle_t ltHandle, int8_t *A, int8_t *out, int dim1, int dim2);
template void transform<int8_t, COL32, ROW, false, 8>(hipblasHandle_t ltHandle, int8_t *A, int8_t *out, int dim1, int dim2);
template void transform<int32_t, COL32, ROW, false, 32>(hipblasHandle_t ltHandle, int32_t *A, int32_t *out, int dim1, int dim2);

template <int FORMATB, int DTYPE_OUT, int SCALE_ROWS> int igemmlt(hipblasHandle_t ltHandle, int m, int n, int k, const int8_t *A, const int8_t *B, void *C, float *row_scale, int lda, int ldb, int ldc)
{
#ifdef NO_HIPBLASLT
  cout << "" << endl;
  cout << "=============================================" << endl;
  ...
  assert(false);
    ...
    hipsparseOrder_t' col32 = HIPBLASLT_ORDER_COL32;
    hipsparseOrder_t' col_turing = HIPBLASLT_ORDER_COL4_4R2_8C;
    hipsparseOrder_t' col_ampere = HIPBLASLT_ORDER_COL32_2R_4R4;

    has_error |= checkHipblasStatus(hipblasLtMatrixLayoutCreate(&Adesc, CUDA_R_8I, m, k, lda));
    has_error |= checkHipblasStatus(hipblasLtMatrixLayoutCreate(&Bdesc, CUDA_R_8I, n, k, ldb));
    ...
    if(DTYPE_OUT == 32)
    {
      has_error |= checkHipblasStatus(hipblasLtMatmulDescCreate(&matmulDesc, HIPBLAS_COMPUTE_32I, CUDA_R_32I));
      has_error |= checkHipblasStatus(hipblasLtMatmulDescSetAttribute(matmulDesc, HIPBLASLT_MATMUL_DESC_TRANSB, &opT, sizeof(opT)));
      has_error |= checkHipblasStatus(hipblasLtMatrixLayoutCreate(&Cdesc, CUDA_R_32I, m, n, ldc));
    ...
    {
      has_error |= checkHipblasStatus(hipblasLtMatmulDescCreate(&matmulDesc, HIPBLAS_COMPUTE_32I, CUDA_R_32F));
      has_error |= checkHipblasStatus(hipblasLtMatmulDescSetAttribute(matmulDesc, HIPBLASLT_MATMUL_DESC_TRANSB, &opT, sizeof(opT)));
      has_error |= checkHipblasStatus(hipblasLtMatrixLayoutCreate(&Cdesc, CUDA_R_8I, m, n, ldc));
      has_error |= checkHipblasStatus(hipblasLtMatrixLayoutSetAttribute(Cdesc, HIPBLASLT_MATRIX_LAYOUT_ORDER, &col32, sizeof(col32)));
      if(!SCALE_ROWS)
      {
...
template int igemmlt<COL_TURING, 32, 0>(hipblasHandle_t ltHandle, int m, int n, int k, const int8_t *A, const int8_t *B, void *C, float *row_scale, int lda, int ldb, int ldc);
template int igemmlt<COL_TURING, 8, 0>(hipblasHandle_t ltHandle, int m, int n, int k, const int8_t *A, const int8_t *B, void *C, float *row_scale, int lda, int ldb, int ldc);
template int igemmlt<COL_TURING, 8, 1>(hipblasHandle_t ltHandle, int m, int n, int k, const int8_t *A, const int8_t *B, void *C, float *row_scale, int lda, int ldb, int ldc);
template int igemmlt<COL_AMPERE, 32, 0>(hipblasHandle_t ltHandle, int m, int n, int k, const int8_t *A, const int8_t *B, void *C, float *row_scale, int lda, int ldb, int ldc);
template int igemmlt<COL_AMPERE, 8, 0>(hipblasHandle_t ltHandle, int m, int n, int k, const int8_t *A, const int8_t *B, void *C, float *row_scale, int lda, int ldb, int ldc);
template int igemmlt<COL_AMPERE, 8, 1>(hipblasHandle_t ltHandle, int m, int n, int k, const int8_t *A, const int8_t *B, void *C, float *row_scale, int lda, int ldb, int ldc);
